...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Blood Bank System </a>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="request_blood.php" <?php if($active=='need') echo "class='act'"; ?>>Request Blood</a>
